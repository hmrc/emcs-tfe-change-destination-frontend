      ...
      "User is not logged in" - {
        ...
        "redirect to the sign-in URL with the ContinueURL set" in new Harness {
          ...
          redirectLocation(result) mustBe
            Some(s"http://localhost:9949/auth-login-stub/gg-sign-in" +
              s"?continue=http%3A%2F%2Flocalhost%3A8319%2Femcs%2Fchange-destination%2Ftrader%2F$testErn%2Fmovement%2F$testArc")
        }
      }
