...
class TransportArrangerReviewFormProviderSpec extends SpecBase with OptionFieldBehaviours {

  val requiredKey = "transportArrangerReview.error.required"
  val invalidKey = "error.invalid"

  val form = new TransportArrangerReviewFormProvider()()
  ...
  "Error messages" - {
    ...
    Seq(TransportArrangerReviewMessages.English).foreach { messagesForLang =>
