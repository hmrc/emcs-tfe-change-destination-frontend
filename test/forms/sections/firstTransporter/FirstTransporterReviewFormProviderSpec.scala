...
class FirstTransporterReviewFormProviderSpec extends SpecBase with OptionFieldBehaviours {

  val requiredKey = "firstTransporterReview.error.required"
  val invalidKey = "error.invalid"

  val form = new FirstTransporterReviewFormProvider()()
  ...
  "Error messages" - {
    ...
    Seq(FirstTransporterReviewMessages.English).foreach { messagesForLang =>
