...
class TransportUnitsReviewFormProviderSpec extends SpecBase with OptionFieldBehaviours {

  val requiredKey = "transportUnitsReview.error.required"
  val invalidKey = "error.invalid"

  val form = new TransportUnitsReviewFormProvider()()
  ...
  "Error messages" - {
    ...
    Seq(TransportUnitReviewMessages.English).foreach { messagesForLang =>
