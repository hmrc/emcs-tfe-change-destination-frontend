...
case class TransportUnitGiveMoreInformationChoicePage(idx: Index) extends QuestionPage[Boolean] {
  override val toString: String = "transportUnitGiveMoreInformationChoice"
