...
case class ChangeDestinationNRSSubmission(ern: String,
...
object ChangeDestinationNRSSubmission {
  implicit val writes: Writes[ChangeDestinationNRSSubmission] = Writes(_.json)
}
