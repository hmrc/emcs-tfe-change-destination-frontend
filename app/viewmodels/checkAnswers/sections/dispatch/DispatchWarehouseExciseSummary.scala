...
object DispatchWarehouseExciseSummary {
      ...
      answer =>
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel(
              content = "site.change",
              href = controllers.sections.dispatch.routes.DispatchWarehouseExciseController.onPageLoad(answers.ern, answers.arc, CheckMode).url,
