...
object InformationDeferredMovementSummary {
  ...
  def row()(implicit request: DataRequest[_], messages: Messages): Option[SummaryListRow] = {
    ...
    Some(
      SummaryListRowViewModel(
        key = "deferredMovement.checkYourAnswersLabel",
        ...
        actions = Seq(
          ActionItemViewModel(
            ...
            if (isOnPreDraftFlow) {
              ...
              controllers.sections.info.routes.DeferredMovementController.onPageLoad(ern = request.ern, request.arc).url
            },
