...
class TransportArrangerNameHelper @Inject()(p: views.html.components.p) {

  private def messageFor(key: String, transportArranger: TransportArranger)(implicit messages: Messages) =
