...
import models.nrs.{ChangeDestinationNRSSubmission, IdentityData, NRSPayload}
...
class NRSBrokerService @Inject()(brokerConnector: NRSBrokerConnector,
  ...
  def submitPayload(submitCreateMovementModel: SubmitChangeDestinationModel, ern: String)
    ...
    val submissionAsString = Json.stringify(Json.toJson(ChangeDestinationNRSSubmission(ern, submitCreateMovementModel)))
